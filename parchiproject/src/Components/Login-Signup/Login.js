...
import WhitePracto from "../../Assets/logo_w.png"
...
function Login() {
  ...
  return (
    <div>
      ...
      <div className="SmartPhoneUI">
        
        <div className="BackGroundColor">
          <img
            src={WhitePracto}
            className="whitePractoLogo"
          />

          {/* Login and Signup PNG Icon */}
          <div>
            {
              activeButton === "login" ?
              (
                <div>
                  <img src={LoginImage} className="LoginIcon" />
                </div>
              ) :
              (
                <div>
                  <img src={SignupImage} className="SignInIcon" />
                </div>
              )
            }
          </div>
        ...
        <div className="Login-Signup-OptionsButton">
          <button
            className={`button ${activeButton === "login" ? "active" : ""}`}
            onClick={() => handleButtonClick("login")}
          >
